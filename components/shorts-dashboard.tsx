...
export function ShortsDashboard() {
  ...
  async function scan() {
    ...
    const query = new URLSearchParams({ region: filters.region, category: filters.category, subcategory: advancedFiltersOpen ? selectedSubcategory : "", subNiche: advancedFiltersOpen ? filters.subNiche ?? "" : "", niche: advancedFiltersOpen ? filters.niche : "", platform: filters.platform, timeRange: filters.timeRange });
    try {
